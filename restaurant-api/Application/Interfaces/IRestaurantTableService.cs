...
namespace Template_restaurant_app.Application.Interfaces
{
    public interface IRestaurantTableService
    {
        ...
        public Task<Result<ReturnTableDto>> StatusAsync(Guid id, Guid userId, ChangeTableStatusDto status);
        public Task<Result<ReturnTableDto>> ReservationAsync(Guid id, Guid userId, ResevationTableDto resevation);
